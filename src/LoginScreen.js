      ...
      <body>
        ...
        >
          <input
            ...
            required
          />
          <label for="username">Username</label> <small>Red Hat ID</small>{" "}
          <svg viewbox="0 0 10 10">
            <use xlinkHref="#user" />
            <use xlinkHref="#fed" className="fedora" />
            <use xlinkHhref="#burst" className="flash" />
          </svg>
          <input
            id="password"
            type="password"
            ...
            required
          />
          <label for="password">Password</label> <small>PIN + Token</small>{" "}
          <svg viewbox="0 0 10 10">
            <use xlinkHref="#pad" />
          ...
          <span className="note" id="note">
            NOTE: You must close your browser or clear your cookies to
            completely log out.
          </span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <svg className="hide">
          <defs>
            ...
            <path
              id="fed"
              d="M7.8 3.8c-.7.6-3.5.6-4.4-.1-.3-.2 4.8-.2 4.4.1zM7 3.5c-.4-.7-.3-2-1.5-1.5-1-.5-1 .7-1.5 1.5"
            />

            <path
              id="user"
              d="M5.5 5.8c-2 0-2-3 0-3 2.3 0 2 3 0 3zm.8-.3c1.2 0 2.2 1 2.2 2.3v1.7h-6V7.7c0-1.2 1-2.2 2.3-2.2"
            />
            <path
              id="burst"
              d="m 5.47,0 v 2.19 m 4.38,2.19 h -2.2 m -6.55,0 H 3.28 M 2.38,1.28 3.92,2.83 M 8.56,1.28 7.02,2.83"
            />
          </defs>
        </svg>
      </body>
